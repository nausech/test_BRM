...
class facturasController extends AppBaseController
{
    ...
    {
        $facturas = DB::select("select f.id, f.fac_cantidad, f.created_at, f.updated_at, f. deleted_at,  f.fac_cliente, f.fac_total, p.pro_nombre from facturas f inner join productos p on p.id=f.fac_producto");
    ...
    public function store(CreatefacturasRequest $request)
    {
        ...
        Flash::success('Factura guardada.');
    ...
    {
        $facturas = DB::select("select f.id as fid, f.fac_cantidad, f.created_at, f.updated_at, f. deleted_at,  f.fac_cliente, f.fac_total, p.pro_nombre from facturas f inner join productos p on p.id=f.fac_producto where f.id=".$id);
        if (empty($facturas)) {
    ...
    public function update($id, UpdatefacturasRequest $request)
    {
        ...
        Flash::success('Facturas actualizada.');
    ...
    public function destroy($id)
    {
        ...
        Flash::success('Facturas eliminada.');
